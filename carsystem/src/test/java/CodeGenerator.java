...
import com.carsystem.core.ProjectConstant;
import com.carsystem.util.TableUtil;
...
public class CodeGenerator {
    //JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://127.0.0.1:3306/carsystem?autoReconnect=true&failOverReadOnly=false";
...
//    	List<String> selectAlltableName = TableUtil.selectAlltableName("jdbc:mysql://127.0.0.1:3306/yaohao", "yaohao");
//    	System.out.println(selectAlltableName);
//    	List<String> sList=TableUtil.selectAlltableName(JDBC_URL, "carsystem");
     ...
     *
     * @param selectAlltableName 数据表名称...
     */
    public static void genCode(List<String> selectAlltableName) {
        for (String tableName : selectAlltableName) {
